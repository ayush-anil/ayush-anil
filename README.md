...
using Logistic Regression & Decision Tree in R Studio.

### 📌 [Instagram Profile Analytics — Fake Account Detection](#)
Built classification models to predict fake vs real Instagram accounts  
using Logistic Regression & Decision Tree with confusion matrix evaluation.

### 📌 [Careem 2018 Data Breach — Ethics & Security Case Study](#)
Analyzed the 2018 Careem data breach to identify security vulnerabilities,  
